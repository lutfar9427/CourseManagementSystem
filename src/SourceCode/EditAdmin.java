...
public class EditAdmin extends javax.swing.JFrame {
    ...
    public void searchFunction() {
        String searchSQL = "select * from Account where UserName = ? and UserType = 'Admin'";
        ...
        try {
            ...
            if(result.next()) {
                ...
                Functions.clearTextField(jPanelEditAdmin);
    ...
    public void editFunction() {
        ...
        try {
            ...
            prepare.execute();
            JOptionPane.showMessageDialog(null, "The Admin updated!");
        } catch(SQLException ex) {
            Logger.getLogger(EditAdmin.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void deleteFunction() {
        ...
        try {
            if(!"".equals(realName)) {
                ...
                prepare.execute();
                JOptionPane.showMessageDialog(null, "The Admin deleted!");
                Functions.clearTextField(jPanelEditAdmin);
            }
        } catch(SQLException ex) {
            Logger.getLogger(EditAdmin.class.getName()).log(Level.SEVERE, null, ex);
    ...
    private void initComponents() {
        ...
        jPanelEditAdmin = new javax.swing.JPanel();
        ...
        setTitle("CMS - Edit Admin");

        jPanelEditAdmin.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Edit Admin", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Dialog", 3, 24))); // NOI18N
        ...
        javax.swing.GroupLayout jPanelEditAdminLayout = new javax.swing.GroupLayout(jPanelEditAdmin);
        jPanelEditAdmin.setLayout(jPanelEditAdminLayout);
        jPanelEditAdminLayout.setHorizontalGroup(
            jPanelEditAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelEditAdminLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanelEditAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanelEditAdminLayout.createSequentialGroup()
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanelEditAdminLayout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanelEditAdminLayout.setVerticalGroup(
            jPanelEditAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jPanelEditAdminLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(jPanelEditAdminLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jPanelEditAdmin, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(30, Short.MAX_VALUE))
...
//        }
    ...
    private javax.swing.JPanel jPanelEditAdmin;
